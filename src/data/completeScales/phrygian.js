const baseScaleMap = {
  fingers: [
    ...
    [6, 3, { text: "6" }],
    [6, 5, { text: "♭7" }],
    [6, 7, { text: "R", color: "red", textColor: "white" }],
    [6, 8, { text: "♭2" }],
    [6, 10, { text: "3", color: "pink" }],
    [6, 12, { text: "4" }],
    // 5th string
    [5, 0, { text: "A" }],
    [5, 2, { text: "R", color: "red", textColor: "white" }],
    [5, 3, { text: "♭2" }],
    ...
    [4, 5, { text: "6" }],
    [4, 7, { text: "♭7" }],
    [4, 9, { text: "R", color: "red", textColor: "white" }],
    [4, 10, { text: "♭2" }],
    [4, 12, { text: "3", color: "pink" }],
    // 3rd string
    [3, 0, { text: "G" }],
    [3, 2, { text: "♭7" }],
    [3, 4, { text: "R", color: "red", textColor: "white" }],
    [3, 5, { text: "♭2" }],
    ...
    [2, 8, { text: "6" }],
    [2, 10, { text: "♭7" }],
    [2, 12, { text: "R", color: "red", textColor: "white" }],
    // 1st string
    [1, 0, { text: "e" }],
    [1, 2, { text: "5", color: "pink" }],
    [1, 3, { text: "6" }],
    [1, 5, { text: "♭7" }],
    [1, 7, { text: "R", color: "red", textColor: "white" }],
    [1, 8, { text: "♭2" }],
