const baseScaleMap = {
  fingers: [
    ...
    // 6th string
    [6, 0, { text: "E" }],
    [6, 2, { text: "R", color: "red", textColor: "white" }],
    [6, 3, { text: "2" }],
    ...
    [5, 5, { text: "6" }],
    [5, 7, { text: "♭7" }],
    [5, 9, { text: "R", color: "red", textColor: "white" }],
    [5, 10, { text: "2" }],
    ...
    [4, 0, { text: "D" }],
    [4, 2, { text: "♭7" }],
    [4, 4, { text: "R", color: "red", textColor: "white" }],
    [4, 5, { text: "2" }],
    ...
    [3, 7, { text: "6" }],
    [3, 9, { text: "♭7" }],
    [3, 11, { text: "R", color: "red", textColor: "white" }],
    [3, 12, { text: "2" }],
    // 2nd string
    [2, 0, { text: "B" }],
    ...
    [2, 3, { text: "6" }],
    [2, 5, { text: "♭7" }],
    [2, 7, { text: "R", color: "red", textColor: "white" }],
    [2, 8, { text: "2" }],
    [2, 10, { text: "♭3", color: "pink" }],
    [2, 12, { text: "4" }],
    // 1st string
    [1, 0, { text: "e" }],
    [1, 2, { text: "R", color: "red", textColor: "white" }],
    [1, 3, { text: "2" }],
